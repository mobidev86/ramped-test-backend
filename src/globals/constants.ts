...
export const successUserCreated = 'User created successfully'
export const successUserLoggedIn = 'User logged in successfully'
export const successJobListed = 'Job posts are listed'